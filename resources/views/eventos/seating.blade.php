...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Seating invitados with class invitado:', invitadosEl ? invitadosEl.querySelectorAll(
                '.invitado').length : 'null');
            ...
            document.querySelectorAll('.asiento').forEach(asiento => {
                ...
                try {
                    new Sortable(asiento, {
                        group: 'seating',
                        animation: 150,
                        draggable: ".invitado:not(.assigned)",
                        sort: false,
                        ...
                        onAdd(evt) {
                            ...
                            const invitadosEnAsiento = Array.from(asiento.querySelectorAll(
                                    '.invitado'))
                                .filter(el => el !== item);
