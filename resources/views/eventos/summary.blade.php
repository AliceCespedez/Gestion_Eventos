...
<head>
    ...
    <style>
        ...
        .kpi-total { border-left: 6px solid #A8D8FF; }
        .kpi-ok { border-left: 6px solid #B8F2D3; }
        .kpi-pend { border-left: 6px solid #FFE5A8; }
        .kpi-no { border-left: 6px solid #FFB6C1; }
...
<div class="container mt-4">
    ...
    <div class="section">
            ...
            <table class="table table-hover align-middle">
                ...
                @foreach ($evento->menus as $menu)
                    <tr>
                        ...
                        <td><strong>{{ $menu->precio_unitario * $menu->pivot->cantidad }} €</strong></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
        ...
        @else
            <p class="text-muted">No hay catering contratado</p>
        @endif
    </div>

    <!-- TOTAL -->
    <div class="section text-center">
        <h5 style="color:#636e72;">Coste total estimado</h5>
        <h2 style="color:#A8D8FF;">{{ $totalCatering }} €</h2>
    </div>
